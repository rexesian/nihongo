    ...
    Kanji = colDef(
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 25, fontWeight = 200), w1, "・", w2, "・", w3),
          div(style = list(fontSize = 25, fontWeight = 200), w4, "・", w5, "・", w6),
          div(style = list(fontSize = 25, fontWeight = 200), w7, "・", w8, "・", w9),
        )
      },
      align = "center"
    ),
