...
reactable(
  ...
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(528:586))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  ...
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(595:625))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  ...
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(722:745))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  srvb2 %>% slice(1089:1107),
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(1089:1107))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  srvb2 %>% slice(1108:1136),
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(1108:1136))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  srvb2 %>% slice(1137:1143),
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(1137:1143))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  srvb2 %>% slice(1144:1151),
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(1144:1151))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
reactable(
  srvb2 %>% slice(1180:1190),
  columns = list(
    Verbs = colDef(
      # Show species under character names
      cell = function(value, index) {
        Meaning <- (srvb2 %>% slice(1180:1190))$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Meaning)
...
<p style="font-size:12px;">(❖) Attached to a noun to describe likeness in inner characteristics</p> 
...
# v1hmed <- v1hme %>% select(Categories) %>%
#   separate(Categories, into = c('Script','Transcript'), sep = '\\#') %>%
#   select(Script,Transcript)
# v1hmed  <- v1hmed [sample(1:nrow(na.omit(v1hmed ))),]
