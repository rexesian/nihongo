...
reactable(
  ...
  columns = list(
    Meaning = colDef(
      # Show species under character names
      cell = function(value, index) {
        Verbs <- (srvb2 %>% slice(65:249))$Verbs[index]
        Verbs <- if (!is.na(Verbs)) Verbs else "Unknown"
        tagList(
          div(style = list(fontSize = 20, fontWeight = 700), value),
          # div(style = list(fontSize = 11), Verbs)
...
reactable(
  ...
  theme = reactableTheme(
    # Vertically center cells
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", height = 200),
    searchInputStyle = list(
      paddingLeft = "8px",
      paddingTop = "8px",
      paddingBottom = "8px",
  ...
  columns = list(
    Script = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 10, fontWeight = 200), Transcript)
        )
      },
      align = "center"
    ),
