...
<!--           div(style = list(fontSize = 20, fontWeight = 500), w2), -->
<!--           div(style = list(fontSize = 20, fontWeight = 500), w3), -->
<!--         ) -->
<!--       }, -->
<!--       align = "left" -->
<!--     ),    -->
  ...
  columns = list(
    Word = colDef(
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 500), value, "・", w2, "・", w3, "・", w4, "・", w5),
          div(style = list(fontSize = 25, fontWeight = 500), w6, "・", w7, "・", w8, "・", w9, "・", w10),
          div(style = list(fontSize = 25, fontWeight = 500), w11, "・", w12, "・", w13, "・", w4, "・", w15)
        )
      },
      align = "center"
    ),
