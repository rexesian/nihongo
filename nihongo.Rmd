  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 30, fontWeight = 800), value),
          div(style = list(fontSize = 15, fontWeight = 700), Expn),
          div(style = list(fontSize = 14, fontWeight = 200), Trans),
          div("•"),
          div(style = list(fontSize = 20, fontWeight = 700), Convo1),
          div(style = list(fontSize = 20, fontWeight = 700), Convo2),
          div(style = list(fontSize = 20, fontWeight = 700), Convo3),
          div(style = list(fontSize = 20, fontWeight = 700), Convo4),
          div(style = list(fontSize = 20, fontWeight = 700), Convo5),
          div(style = list(fontSize = 20, fontWeight = 700), Convo6),
          div(style = list(fontSize = 20, fontWeight = 700), Convo7),
          div(style = list(fontSize = 20, fontWeight = 700), Convo8),
          div(style = list(fontSize = 20, fontWeight = 700), Convo9),
        )
      },
      align = "left", minWidth = 400
      ),
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          div(style = list(fontSize = 25, fontWeight = 800), value),
          div(style = list(fontSize = 13, fontWeight = 200), A),
          div(style = list(fontSize = 13, fontWeight = 200), B),
          div(style = list(fontSize = 13, fontWeight = 200), C),
          div(style = list(fontSize = 13, fontWeight = 200), D)
        )
      },
      align = "left", minWidth = 400
      ),
