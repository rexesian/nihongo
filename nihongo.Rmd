  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 14, fontWeight = 200), s3),
          div(style = list(fontSize = 14, fontWeight = 200), s4),
          div(style = list(fontSize = 14, fontWeight = 200), s5),
        )
      },
      align = "center", minWidth = 400
      ),
...
<!-- <h>     -->
    ...
    ・Only Yuki-san came
    ・I ate only fish
    ・I just ate a fish, that's all
    ・I borrowed books only
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 17, fontWeight = 700), Expression),
