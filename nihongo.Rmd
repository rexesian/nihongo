...
<!--         tagList( -->
<!--           div(style = list(fontSize = 20, fontWeight = 700), value), -->
<!--           div(style = list(fontSize = 11), Reading), -->
<!--           div(style = list(fontSize = 11), Meaning), -->
<!--           div(style = list(fontSize = 13), "・"), -->
<!--           div(style = list(fontSize = 17, fontWeight = 500), w1), -->
<!--           div(style = list(fontSize = 17, fontWeight = 500), w2), -->
<!--           # div(style = list(fontSize = 17, fontWeight = 500), w3), -->
<!--         ) -->
<!--       }, -->
<!--       align = "center" -->
<!--     ), -->
    ...
    Kanji = colDef(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 11), Reading),
          div(style = list(fontSize = 13), Meaning)
        )
      },
      align = "center"
    ),
