...
*Transition from one state to another*
    ...
    ・知る・死ぬ・入る・咲く・空く・閉じる・壊れる 

<!-- <h>  -->

    ・to realize・to die・to enter・to bloom・to be vacant・to close・to break apart

*Start of action or motion from static state*

    ・散る・立つ・落ちる・倒れる

<!-- <h>  -->

    ・to fall/scatter・to stand up・to fall (from height)・to fall over

*Arrival of completion*

    ・着く・届く・触れる

<!-- <h>  -->

    ・to arrive・to reach・to touch
    
*More Examples*

    ・上げる・もらう・疲れる・困る・乗・始まる・終わる・打つ・出る・座る
    ・起きる・結婚する・行く・来る・帰る・言う・忘れる・貸す・借りる・飛ぶ
...
<!-- <h>  -->
    ...
    ・The calendar has been hanged on the wall
...
###### **⚭　Punctual Verb-te + iru/aru: 暮らす・根ざす・残る・落ち着く・住む・泊まる・勤める・浮かぶ・横たわる・座る・立つ**
...
**Note:**
General concept of de particle is setting a limit or a boundary
...
###### Expression of expectation, intention, or desire such as と思っていた(I thought), つもりだった(I intended), てほしかった(I wanted someone to)
...
###### End of a counter-factual conditional snetence
...
###### Expresses the development of a logical argument if it’s is such-and-such, but that was not result/case for others (could be less or more)
