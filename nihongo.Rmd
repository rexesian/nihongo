...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        Core <- na.omit(kndsm)$Core[index]
        Core <- if (!is.na(Core)) Core else "Unknown"
        Onyomi <- na.omit(kndsm)$Onyomi[index]
        Onyomi <- if (!is.na(Onyomi)) Onyomi else "Unknown"
        Kunyomi <- na.omit(kndsm)$Kunyomi[index]
        Kunyomi <- if (!is.na(Kunyomi)) Kunyomi else "Unknown"
        Words <- na.omit(kndsm)$Words[index]
        Words <- if (!is.na(Words)) Words else "Unknown"
        Meaning <- na.omit(kndsm)$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          # div(style = list(fontSize = 35, fontWeight = 800), value),
          # div(style = list(fontSize = 11, fontWeight = 200), Core),
...
reactable(
  ...
  columns = list(
      ...
      cell = function(value, index) {
        Core <- na.omit(kndsr)$Core[index]
        Core <- if (!is.na(Core)) Core else "Unknown"
        Onyomi <- na.omit(kndsr)$Onyomi[index]
        Onyomi <- if (!is.na(Onyomi)) Onyomi else "Unknown"
        Kunyomi <- na.omit(kndsr)$Kunyomi[index]
        Kunyomi <- if (!is.na(Kunyomi)) Kunyomi else "Unknown"
        Words <- na.omit(kndsr)$Words[index]
        Words <- if (!is.na(Words)) Words else "Unknown"
        Meaning <- na.omit(kndsr)$Meaning[index]
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        tagList(
          # div(style = list(fontSize = 35, fontWeight = 800), value),
          # div(style = list(fontSize = 11, fontWeight = 200), Core),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(528:586))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(595:625))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(722:745))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(1089:1107))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(1108:1136))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(1137:1143))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(1144:1151))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Verbs = colDef(
      ...
      cell = function(value, index) {
        ...
        Meaning <- if (!is.na(Meaning)) Meaning else "Unknown"
        Reading <- (srvb2 %>% slice(1180:1190))$Reading[index]
        Reading <- if (!is.na(Reading)) Reading else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), value),
          div(style = list(fontSize = 13), Reading),
  ...
  columns = list(
    Meaning = colDef(
      ...
      cell = function(value, index) {
        ...
        Verbs <- if (!is.na(Verbs)) Verbs else "Unknown"
        tagList(
          div(style = list(fontSize = 30, fontWeight = 700), Verbs),
  ...
  columns = list(
      ...
      cell = function(value, index) {
        ...
        tagList(
          ...
          div(style = list(fontSize = 14, fontWeight = 700), Trans),
          div("•"),
          div(style = list(fontSize = 20, fontWeight = 500), Convo1),
          div(style = list(fontSize = 20, fontWeight = 500), Convo2),
          div(style = list(fontSize = 20, fontWeight = 500), Convo3),
          div(style = list(fontSize = 20, fontWeight = 500), Convo4),
          div(style = list(fontSize = 20, fontWeight = 500), Convo5),
          div(style = list(fontSize = 20, fontWeight = 500), Convo6),
          div(style = list(fontSize = 20, fontWeight = 500), Convo7),
          div(style = list(fontSize = 20, fontWeight = 500), Convo8),
          div(style = list(fontSize = 20, fontWeight = 500), Convo9),
        )
      },
      align = "left", minWidth = 400
      ),
...
reactable(na.omit(rdngr), showPageSizeOptions = FALSE,
          ...
          showPageInfo = FALSE, defaultPageSize = 10, height = 550,
          style = list(fontFamily =  "Hiragino Maru Gothic ProN, Anonymous Pro , Helvetica Neue", fontSize = "11px", fontWeight = 350),
    ...
    theme = reactableTheme(
    cellStyle = list(display = "flex", flexDirection = "column", justifyContent = "center", fontSize = "18px", fontWeight = 300),
